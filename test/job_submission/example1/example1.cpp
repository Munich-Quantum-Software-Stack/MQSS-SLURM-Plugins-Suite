...
{
        cout << "----------------------------" << endl;
        cout << "Try a fake-qpu job on slurm_node1" << endl;
        cout << "----------------------------" << endl;

        float x0=0, y0=0, z0=0, x1, y1, z1, e1, e2, e3, e;
        int step=1;

        /* Setting precision and writing floating values in fixed-point notation. */
	...
	do
        ...
        cout << endl << "----------------------------" << endl;
        cout << endl << "Sleep for a while in 30s ..." << endl;
        usleep(30000000);
